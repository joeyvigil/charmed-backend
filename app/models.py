...
from sqlalchemy import Date, ForeignKey, Text, LargeBinary, Boolean
...
class Users(Base):
    ...
    theme: Mapped[str] = mapped_column(Text, default='latte')
    video: Mapped[str] = mapped_column(Text, default='cat_rain.mp4')
    var1: Mapped[str] = mapped_column(Text, default='')
    var2: Mapped[str] = mapped_column(Text, default='')
    var3: Mapped[str] = mapped_column(Text, default='')
    var4: Mapped[str] = mapped_column(Text, default='')
    var5: Mapped[str] = mapped_column(Text, default='')
    var6: Mapped[str] = mapped_column(Text, default='')
